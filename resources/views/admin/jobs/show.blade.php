    ...
    <div class="card bg-gradient-primary text-white shadow-lg border-0 mb-4">
        <div class="card-body py-3">
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <a href="{{ route('admin.jobs.edit', $job) }}" class="btn btn-warning me-2">
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <span class="badge badge-{{ $job->status == 'active' ? 'success' : ($job->status == 'inactive' ? 'secondary' : 'danger') }} me-2">
                            {{ ucfirst($job->status) }}
                        </span>
                        <span class="badge badge-{{ $job->visibility == 'featured' ? 'warning' : 'info' }}">
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-12">
                            ...
                            <div class="d-flex align-items-center text-muted">
                                ...
                                <a href="{{ route('admin.companies.show', $job->company) }}" class="text-decoration-none">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <span class="ms-2">{{ $job->jobType->name ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-6 mb-3">
                            <strong>Employment Type:</strong>
                            <span class="ms-2">{{ ucfirst(str_replace('_', ' ', $job->employment_type)) }}</span>
                        </div>
                        <div class="col-md-6 mb-3">
                            <strong>Experience Level:</strong>
                            <span class="ms-2">{{ $job->experience_level ? ucfirst($job->experience_level) : 'Not specified' }}</span>
                        </div>
                        <div class="col-md-6 mb-3">
                            <strong>Available Positions:</strong>
                            <span class="ms-2">{{ $job->available_positions }}</span>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <span class="ms-2">
                                ...
                                @endif
                                <small class="text-muted">/ {{ $job->salary_type }}</small>
                            </span>
                        </div>
                        @endif
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <span class="ms-2">{{ $job->application_deadline->format('M d, Y') }}</span>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-2">{{ $job->description }}</div>
                    </div>
                    @endif
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-2">{{ $job->requirements }}</div>
                    </div>
                    @endif
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge badge-primary">{{ $job->applications()->count() }} Total</span>
                </div>
                <div class="card-body">
                    @forelse($job->applications()->with('candidate.user')->latest()->take(10)->get() as $application)
        ...
        <div class="col-lg-4">
                    ...
                    <div class="row text-center">
                        <div class="col-6 mb-3">
                            <div class="border-end">
                                <h4 class="mb-0 text-primary">{{ number_format($job->views_count ?? 0) }}</h4>
                        ...
                        <div class="col-6">
                            <h4 class="mb-0 text-warning">{{ $job->applications()->where('status', 'shortlisted')->count() }}</h4>
                            <small class="text-muted">Shortlisted</small>
                        </div>
                        <div class="col-6">
                            <h4 class="mb-0 text-info">{{ $job->applications()->where('status', 'selected')->count() }}</h4>
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="text-center mb-3">
                        @if($job->company->logo)
                            <img src="{{ asset($job->company->logo) }}" class="img-thumbnail" 
                    ...
                    <h6 class="text-center mb-3">{{ $job->company->company_name }}</h6>
                    <ul class="list-unstyled">
                        @if($job->company->industry)
                        <li class="mb-2">
                            <strong>Industry:</strong> {{ $job->company->industry->name }}
                        </li>
                        @endif
                        @if($job->company->company_size)
                        <li class="mb-2">
                            <strong>Size:</strong> {{ $job->company->company_size }} employees
                        </li>
                        @endif
                        ...
                        <li class="mb-2">
                            ...
                            <span class="badge badge-{{ $job->company->verification_status == 'verified' ? 'success' : 'warning' }}">
                                {{ ucfirst($job->company->verification_status) }}
                            </span>
                        </li>
                    </ul>
                    <div class="text-center">
                        <a href="{{ route('admin.companies.show', $job->company) }}" class="btn btn-outline-primary btn-sm">
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <strong>Last Updated:</strong> {{ $job->updated_at->format('M d, Y') }}
                    </div>
                    @if($job->is_urgent)
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        @if($job->status == 'active')
                            <form action="{{ route('admin.jobs.change-status', $job) }}" method="POST" class="d-inline">
                                @csrf
